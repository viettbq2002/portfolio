...
export const EvervaultCard = ({ text, className, svg }: { text?: string; className?: string; svg: JSX.Element }) => {
        ...
        <div className="relative z-10 flex items-center justify-center">
          <div className="relative h-44 w-44  rounded-full flex items-center justify-center text-white font-bold text-3xl">
            ...
            <div className="flex flex-col items-center justify-center text-center gap-2">
              <div className="dark:text-white text-black z-20">{text}</div>
              <div className="dark:text-white text-black z-20">{svg}</div>
            </div>
          </div>
        </div>
      </div>
