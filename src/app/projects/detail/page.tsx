import { ReactIcon } from "@/components/custom-icon/react-icon";
...
const ProjectDetails = ({ params, searchParams }: { params: { slug: string }; searchParams: { [key: string]: string | string[] | undefined } }) => {
  ...
  return (
    <div className="  pt-20   container ">
      <Button variant={"link"}>
        <Link className="font-bold text-2xl" href={`/projects`}>← Go back</Link>
      </Button>
      ...
      <div className="backdrop-blur-lg p-4 shadow-lg  bg-white/30">
        ...
        <div className="flex justify-center mt-10 w-full items-center flex-col ">
          <h1 className={"text-4xl  font-bold   dark:text-white text-black  " + lilyScriptOne.className}>Tech Stack</h1>
